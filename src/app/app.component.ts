...
export class MyApp {
  ...
  constructor(platform: Platform, statusBar: StatusBar, splashScreen: SplashScreen, sm: StorageManager, event: Events, webIntent: WebIntent, device: Device, storage: LocalStorage, translate: TranslateService, intentManager: IntentManager) {
    ...
    platform.ready().then(async() => {
      ...
      if (device.platform == "Android") {
        ...
        webIntent.getIntent().then((data) => {
          ...
          intentManager.analyseIntent(data);
        }).catch(err => {
